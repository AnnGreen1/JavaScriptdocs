...
更多内容：[现代模式，"use strict"](../2.3-strict-mode/2.3-strict-mode.md)。
...
更多内容：[变量](../2.4-variables/2.4-variables.md) 和 [数据类型](../2.5-types/2.5-types.md)。
...
更多内容：[交互：alert、prompt 和 confirm](../2.6-alert-prompt-confirm/2.6-alert-prompt-confirm.md)。
...
##### 按位运算符
按位运算符在最低位级上操作 32 位的整数：详见 [文档](https://developer.mozilla.org/zh/docs/Web/JavaScript/Guide/Expressions_and_Operators#bitwise_operators)。
...
更多内容：[基础运算符，数学运算](../2.8-operators/2.8-operators.md)，[值的比较](../2.9-comparison/2.9-comparsion.md)，[逻辑运算符](../2.11-logical-operators/2.11-logical-operators.md)，[空值合并运算符 '??'](../2.12-nullish-coalescing-operator/2.12-nullish-coalescing-operator.md)。
...
更多内容：[循环：while 和 for](../2.13-while-for/2.13-while-for.md)。
...
详情请见：["switch" 语句](../2.14-switch/2.14-switch.md)。
...
详细内容：请见 [函数](../2.15-function-basics/2.15-function-basics.md)，[箭头函数，基础知识](../2.17-arrow-functions-basics/2.17-arrow-functions-basics.md)。
